...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        if (id.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Informe o ID do produto.", "Atenção", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        boolean vendido = produtosdao.venderProduto(idProduto);
        
        if (vendido) {
            javax.swing.JOptionPane.showMessageDialog(this, "Produto vendido com sucesso!");
            id_produto_venda.setText("");
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "Não foi possível vender o produto. Verifique o ID informado.", "Erro", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
